'''
Script Name: Node Ops | Align Nodes Horizontally Non-Uniform
...
Description:
    ...
    Automatically aligns the selected nodes horizontally, preserving existing spacing.
...
def align_horizontally_nonuniform(selection):
...
# =============================================================================
    ...
    return [
            ...
            "actions": [
                {
                    "name": "Align Nodes Horizontally Non-Uniform",
                    "isVisible": scope_nodes,
                    "execute": align_horizontally_nonuniform
                }
            ]
        }
        ]
