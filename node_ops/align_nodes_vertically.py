'''
Script Name: Node Ops | Align Nodes Vertically
...
Description:
    ...
    Automatically aligns the selected nodes vertically with equal spacing.
...
def align_vertically(selection):
        ...
        for position in sliced_positions:
            node_lookup[position].pos_y = top_node.pos_y.get_value() - offset
...
# =============================================================================
    ...
    return [
            ...
            "actions": [
                {
                    "name": "Align Nodes Vertically",
                    "isVisible": scope_nodes,
                    "execute": align_vertically
                }
            ]
        }
        ]
